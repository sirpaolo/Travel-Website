...
<head>
  ...
  <title>Selah Pods Hotel Manila — Hotel • Pasay</title>
...
?>
  ...
  <!-- hero -->
  <header class="hero" style="background-image:url('https://pix10.agoda.net/property/63064384/0/5494dea38f89eafb24e2847ab82bf2fd.jpeg?ce=0&s=1024x768')">
    <div class="overlay"></div>
    <div class="container hero-inner">
      <div class="row align-items-end">
        <div class="col-lg-8">
          <h1 class="h2 mb-1">Selah Pods Hotel Manila</h1>
          <div class="d-flex align-items-center mb-2">
            <div class="rating me-3">★ 4.5</div>
            <div class="text-white-50 me-3">(420 reviews)</div>
            <div class="badge bg-light text-dark">Hotels • Pasay</div>
          </div>
          <p class="mb-0">Modern capsule-style hotel located near Ninoy Aquino International Airport — compact, clean pods with shared lounges and coworking space. Instant confirmation.</p>
        </div>
        <div class="col-lg-4 text-lg-end mt-3 mt-lg-0">
          <div class="pill text-white-50">Instant confirmation • 400+ booked</div>
        </div>
      </div>
    </div>
  </header>
    ...
    <div class="row gy-4">
      ...
      <div class="col-lg-8">
        ...
        <div class="row mb-3">
          ...
          <div class="col-12 mb-2">
            <div class="ratio ratio-16x9 rounded overflow-hidden shadow-sm">
              <img id="mainGalleryImg"
                src="https://i1.wp.com/www.howshewanders.com/wp-content/uploads/2019/08/zenrooms-selah-pods-fp.jpg?fit=2400%2C1350&ssl=1"
                alt="main"
                class="w-100 h-100"
          ...
          <div class="col-6">
            <div class="row thumb-row gx-2">
              <div class="col-3">
                <img class="gallery-thumb rounded"
                  src="https://i1.wp.com/www.howshewanders.com/wp-content/uploads/2019/08/zenrooms-selah-pods-fp.jpg?fit=2400%2C1350&ssl=1"
                  data-full="https://i1.wp.com/www.howshewanders.com/wp-content/uploads/2019/08/zenrooms-selah-pods-fp.jpg?fit=2400%2C1350&ssl=1"
                  alt="t1">
              </div>

              <div class="col-3">
                <img class="gallery-thumb rounded"
                  src="https://cdn.studios.skies.asia/www.selahpods.com/large/khy69nHCH3_1589210430.jpg"
                  data-full="https://cdn.studios.skies.asia/www.selahpods.com/large/khy69nHCH3_1589210430.jpg"
                  alt="t2">
              </div>

              <div class="col-3">
                <img class="gallery-thumb rounded"
                  src="https://cdn.studios.skies.asia/www.selahpods.com/fAvlMacLlA_1590551962.jpg"
                  data-full="https://cdn.studios.skies.asia/www.selahpods.com/fAvlMacLlA_1590551962.jpg"
                  alt="t3">
              </div>
        ...
        <section class="mb-4">
          ...
          <p>Selah Pods offers smart, minimal pods designed for short stays and transit travellers. Enjoy a private pod with adjustable lighting, clean linens, and secure lockers — plus shared spaces including a lounge, café, and co-working area.</p>

          <h5>Amenities</h5>
          <div class="d-flex flex-wrap mb-3">
            <div class="amenity"><small class="text-muted">🛏️ Private pod</small></div>
            <div class="amenity"><small class="text-muted">📶 Free Wi-Fi</small></div>
            <div class="amenity"><small class="text-muted">☕ Café & lounge</small></div>
            <div class="amenity"><small class="text-muted">🔐 Personal locker</small></div>
            <div class="amenity"><small class="text-muted">🧺 Daily housekeeping</small></div>
            <div class="amenity"><small class="text-muted">🚕 Airport shuttle (surcharge)</small></div>
          </div>

          <h5>Important to know</h5>
          <ul>
            <li>Check-in from 2:00 PM — Check-out by 11:00 AM</li>
            <li>Lockers available — bring your own luggage lock if preferred</li>
          ...
          <div class="row g-3">
            <div class="col-md-6">
              <div class="card p-3">
                <div class="d-flex justify-content-between">
                  <div>
                    <h6 class="mb-1"><strong>Standard Pod (Shared Bath)</strong></h6>
                    <div class="text-muted small">Compact pod, basic amenities</div>
                  </div>
                  <div class="text-end">
                    <div class="fw-bold">₱ 1,002</div>
            ...
            <div class="col-md-6">
              <div class="card p-3">
                <div class="d-flex justify-content-between">
                  <div>
                    <h6 class="mb-1"><strong>Deluxe Pod (Private Bath)</strong></h6>
                    <div class="text-muted small">Larger pod + ensuite</div>
                  </div>
                  <div class="text-end">
                    <div class="fw-bold">₱ 1,702</div>
                    <div class="text-muted small">per night</div>
                  </div>
                </div>
              </div>
          ...
          <div class="row g-3">
            <div class="col-12 review-card">
              <div class="d-flex justify-content-between mb-2">
                <div>
                  <strong>Hannah L.</strong> <span class="text-muted">• Nov 2025</span>
                </div>
                <div class="rating">★ 4.5</div>
              </div>
              <p class="mb-0">Great location for transit — clean pod and friendly staff. Perfect for a short overnight before a flight.</p>
            </div>

            <div class="col-12 review-card">
              <div class="d-flex justify-content-between mb-2">
                <div>
                  <strong>Eric P.</strong> <span class="text-muted">• Oct 2025</span>
                </div>
                <div class="rating">★ 4.4</div>
              </div>
              <p class="mb-0">Cozy, modern design. The shared lounge is comfortable and the coffee was surprisingly good.</p>
            </div>
          </div>

          <div class="mt-3 text-muted small">Overall: <strong>★4.5</strong> (420 reviews) • 400+ booked</div>
        </section>

        <!-- map / location -->
        <section class="mb-4">
          <h3>Location</h3>
          <p class="text-muted">Pasay, Metro Manila — about 8 minutes drive to Ninoy Aquino Intl. Airport (traffic dependent).</p>
        </section>
        ...
        <div class="booking-panel shadow-sm p-4 bg-white rounded">
          <div class="d-flex justify-content-between align-items-center mb-3">
            <div>
              ...
              <div class="price-large">₱ 1,702</div>
            </div>
            <div class="text-end">
              <div class="rating">★ 4.5</div>
              <div class="text-muted small">(420)</div>
            </div>
          </div>

          <div class="mb-3">
            <label class="form-label small">Check-in</label>
            <input class="form-control" type="date" id="bookDateIn" />
          </div>

          <div class="mb-3">
            <label class="form-label small">Check-out</label>
            <input class="form-control" type="date" id="bookDateOut" />
          </div>
          ...
          <div class="mb-3">
            ...
            <select class="form-select" id="roomSelect">
              <option value="standard">Standard Pod — ₱ 1,002</option>
              <option value="deluxe" selected>Deluxe Pod — ₱ 1,702</option>
            </select>
          </div>
          ...
          <hr>
          <div class="small text-muted">Instant confirmation • Free cancellation up to 24 hours before arrival (subject to policy)</div>
        </div>
      </aside>
...
<footer class="site-footer">
  ...
  <!-- Booking Modal -->
<!-- selah.php booking modal (₱1702) -->
<form id="bookingForm" method="post" action="../connect.php">
  <input type="hidden" name="destination" id="hiddendestination" value="Selah Pods Hotel Manila">
  ...
  <input type="hidden" name="per_person_amount" id="hiddenPerPersonAmount" value="1702">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div id="priceBreakdown" class="mb-2">
            <div class="d-flex justify-content-between"><div class="small text-muted">Per person</div><div class="small fw-bold" id="bdPerPerson">₱ 1,702.00</div></div>
            <div class="d-flex justify-content-between"><div class="small text-muted">Guests</div><div class="small" id="bdGuests">1</div></div>
            <hr>
            <div class="d-flex justify-content-between"><div>Subtotal</div><div id="bdSubtotal" class="fw-bold">₱ 1,702.00</div></div>
            <div class="d-flex justify-content-between"><div>Service fee</div><div id="bdServiceFee">₱ 50.00</div></div>
            <div class="d-flex justify-content-between"><div>Tax (12%)</div><div id="bdTax">₱ 204.24</div></div>
            <hr>
            <div class="d-flex justify-content-between fs-5"><div>Total</div><div id="bdTotal" class="fw-bold fs-5">₱ 1,956.24</div></div>
          </div>
